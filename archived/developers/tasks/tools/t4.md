...
There should be a build action for T4 files in projects that automatically outputs the T4 template iteself as a partial class that can be compiled into the project, [like VS2010](http://www.olegsych.com/2009/09/t4-preprocessed-text-templates/ "http://www.olegsych.com/2009/09/t4-preprocessed-text-templates/").
