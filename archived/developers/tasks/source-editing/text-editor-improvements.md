...
A simple editor could allow the user to pick a few colors and [generate a scheme from them](http://frickinsweet.com/tools/Theme.mvc.aspx "http://frickinsweet.com/tools/Theme.mvc.aspx").

An advanced editor could either allow the user to pick styles from a list of names, or [pick them from a sample document](http://studiostyles.info/ "http://studiostyles.info/"), and set their colors.
